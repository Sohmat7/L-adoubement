...
export class PlayerChoiceComponent {
  ...
  data = [
    ...
    "Maxyoursgarou <br> <br> Main : Ike. <br><br> Plutôt timide, extrêmement gentil et respectueux, va de pair avec CKC tellement ils sont un duo iconique, prend du bon temps à jouer à smash avec son pote et à interagir tranquillement avec ses amis de la commu !",
