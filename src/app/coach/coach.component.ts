...
export class CoachComponent {
  ...
  data = [
    ...
    "Alexandre \"Smog'Oht'\" aka L'encyclopédie <br> <br> Main : Rob. <br> <br> Team : HT <br> <br> Orphelin adopté par un ancien joueur de jeu de combat qui souhaitait transmettre son héritage.",
