...
export class CoachComponent {
  ...
  data = [
    "Dario \"Azerty\" <br> <br> Main : Kazuya. <br> <br> Team : MPT <br> <br> Le père aigri jamais content de ce que font ses enfants. Il te rappellera toujours par ses connaissances et combos que t’as des devoirs à faire et tu sentiras le revers du daron s’il te voit dormir quand tu ne devrais pas.",
    "Fei-long \"Mr.Daiyamondo\" Le dragon volant. <br> <br> Main : Joker. <br> <br> Team : MPT <br> <br> C’est l’eboy sucré retraité de la commu. Depuis qu’il a trouvé un travail il a lâché arsène le grand frère pour se concentrer sur ses véritables passions : freeplay et freefall dans la blast zone.",
    "CKC <br> <br> Main : Captain Falcon. <br> <br>  Team : DC <br> <br> Très bon vivant, sociable, ptit buveur qui aime la vie, toujours souriant et très gentil, va de pair avec MaxyOurs tout pareil et kiff ses ptits tournois dans une ambiance chill et sans prise de tête !",
    ...
    "Alexandre \"Smogoth'\" aka L'encyclopédie <br> <br> Main : Rob. <br> <br> Team : HT <br> <br> Orphelin adopté par un ancien joueur de jeu de combat qui souhaitait transmettre son héritage.",
