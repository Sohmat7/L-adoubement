...
export class StaffComponent {
  ...
  data = [
    "Thomas \"Soma\" AKA Rusty Gear <br><br> Main : La retraite <br> <br> J'ai fait le site. <br><br> Y'a des bugs mais tranquille. <br><br> j'ai une chaine Youtube (Somatv), si vous pouviez lancer les vidéos longues en arrière plan sur un navigateur pour gonfler le nombre d'heure ce serait un soutien de fou x)",
